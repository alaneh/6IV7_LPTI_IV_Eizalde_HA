package com.example.calculadoramaterias_eha_6iv7;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reslt=(EditText)findViewById(R.id.txt_result_parcial1);
        par1reslt=(EditText)findViewById(R.id.txt_result_parcial2);
        par3reslt=(EditText)findViewById(R.id.txt_result_parcial3);
    ...
    public void promedio(View view){
        ...
        String resultmat1 = String.valueOf(df.format(promediomat1));
        String resultmat2 = String.valueOf(df.format(promediomat2));
        String resultmat3 = String.valueOf(df.format(promediomat3));
        String resultmat4 = String.valueOf(df.format(promediomat4));
        String resultmat5 = String.valueOf(df.format(promediomat5));
        String resultmat6 = String.valueOf(df.format(promediomat6));
        String resultmat7 = String.valueOf(df.format(promediomat7));
        String resultmat8 = String.valueOf(df.format(promediomat8));
        String resultmat9 = String.valueOf(df.format(promediomat9));
        String resultmat10 = String.valueOf(df.format(promediomat10));


        String result = String.valueOf(df.format(promedio1par));
        String resultpar2 = String.valueOf(df.format(promedio2par));
        String resultpar3 = String.valueOf(df.format(promedio3par));
        String semresult = String.valueOf(df.format(promediosem));
